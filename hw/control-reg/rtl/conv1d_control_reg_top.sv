...
module conv1d_control_reg_top #(
  ...
  logic control_rst_qs;
  logic control_rst_wd;
  logic control_rst_we;
  ...
  assign control_rst_we    = addr_hit[0] & reg_we & !reg_error;
  assign control_rst_wd    = reg_wdata[1];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      addr_hit[0]: begin
        ...
        reg_rdata_next[1] = control_rst_qs;
      end
